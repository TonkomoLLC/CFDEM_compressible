...
logpath=$casePath
headerText="run_parallel_rhoCfdemSolverPimple_settlingTestMPI_CFDDEM"
logfileName="log_$headerText"
solverName="rhoCfdemSolverPimple"
nrProcs="2"
...
if [ $runOctave == "true" ]
    then
        ...
        #- rmove old graph
        rm rhoCfdemSolverPimple_settlingTestMPI.png

        #- run octave
        octave --no-gui settlingVelocity.m

        #- show plot 
        eog rhoCfdemSolverPimple_settlingTestMPI.png

        #- copy log file to test harness
        cp ../../$logfileName $testHarnessPath
        cp rhoCfdemSolverPimple_settlingTestMPI.png $testHarnessPath
fi
