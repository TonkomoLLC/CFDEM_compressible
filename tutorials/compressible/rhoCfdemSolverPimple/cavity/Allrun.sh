...
# change to rhoCfdemSolverPimpleImExFace + MPI + type Bfull + explicit gradP
...
#gnome-terminal --title='rhoCfdemSolverPimple ErgunTestMPI CFD'  -e "bash $casePath/parCFDDEMrun.sh" 
