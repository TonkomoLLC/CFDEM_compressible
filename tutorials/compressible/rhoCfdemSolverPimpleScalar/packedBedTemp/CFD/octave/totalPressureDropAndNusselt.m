...
dp_sim = (data(:,2)-100000)-(data(:,y)-100000);
t_sim = data(:,1);
...
%print('rhoCfdemSolverPimple_settlingTest.eps','-deps2')
print -color "rhoCfdemSolverPimpleScalar_pressureDrop.png"
...
%path = '../probes/0/Temp'; % ext32
path = '../postProcessing/probes/0/Temp';
...
%print('rhoCfdemSolverPimpleScalar_NusseltNr.eps','-deps2')
print -color "rhoCfdemSolverPimpleScalar_Nusselt.png"
...
%print('rhoCfdemSolverPimpleScalar_NusseltNr.eps','-deps2')
print -color "rhoCfdemSolverPimpleScalar_temperatures.png"
